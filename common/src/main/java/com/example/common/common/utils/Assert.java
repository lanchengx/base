...
public final class Assert {
    ...
    public static void isTrue(boolean expression, String message, String... params) {
        if (!expression) {
            throw ExceptionUtils.newServiceException(message, params);
        }
    }
     ...
     * @param message    消息
     */
    public static void isFalse(boolean expression, String message, String... params) {
     ...
     * @param message 消息
     */
    public static void isNull(Object object, String message, String... params) {
     ...
     * @param message    消息
     */
    public static void notEmpty(Collection<?> collection, String message, String... params) {
     ...
     * @param message 消息
     */
    public static void notEmpty(Map<?, ?> map, String message, String... params) {
     ...
     * @param message 消息
     */
    public static void notEmpty(Object[] array, String message, String... params) {
